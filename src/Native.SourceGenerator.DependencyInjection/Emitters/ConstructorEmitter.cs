...
{
    public static string EmitConstructor(ServiceRegistrationInfo info)
    {
    ...
    private static void EmitConstructorBody(StringBuilder sb, ServiceRegistrationInfo info, string classIndent)
    {
