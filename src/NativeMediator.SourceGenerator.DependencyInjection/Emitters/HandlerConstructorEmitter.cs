...
internal static class HandlerConstructorEmitter
{
    public static string EmitConstructor(HandlerRegistrationInfo info)
    {
    ...
    private static void EmitConstructorBody(StringBuilder sb, HandlerRegistrationInfo info, string classIndent)
    {
